...
<link rel="stylesheet" href="/huawei/Public/Home/css//product.css">
 <div id="content">
 	...
 	<?php if(is_array($productss)): $i = 0; $__LIST__ = $productss;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><i style="display:none" class="product_id"><?php echo ($vo["product_id"]); ?></i>
 		<h4><b><?php echo ($vo["product_name"]); ?></b></h4>
...
<div style="clear:both"></div>
		<button class="button1"><img src="/huawei/Public/Home/image//cart1.png" alt="">加入购物车</button>
