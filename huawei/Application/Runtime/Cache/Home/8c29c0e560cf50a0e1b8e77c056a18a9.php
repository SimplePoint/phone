...
<body style="background: #F1F1F1;">
	...
	<div id="content">
		<ul>
			<li class="phone" style="background:red;"><a href="<?php echo U('User/registerPhone');?>">手机注册</a></li>
			<li class="email"><a href="<?php echo U('User/registerEmail');?>">邮箱注册</a></li>
		</ul>
		<b style="float:right">已有华为帐号<a href="<?php echo U('User/login');?>">登录</a></b>
		...
		<div id="phone">
			...
			<div class="gukuan">
				<h4>华为账号</h4>
				<p>输入手机号码作为您的华为帐号，用于登录、重设密码、验证身份。</p>
				<form action="registerPhoneCheck" method="post" name="form1">
					<div class="form-group">
   						<label for="firstname" class="col-sm-2 control-label">手机号码</label>
    					<div class="col-sm-4">
    					<input type="text" class="form-control" id="firstname" placeholder="请输入手机号码" name="phone" required><span><?php echo ($error); ?></span>
    					</div>
  					</div> 
