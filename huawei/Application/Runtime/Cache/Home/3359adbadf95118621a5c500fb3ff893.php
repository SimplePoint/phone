...
<body style="background: #F1F1F1;">
	...
	<div id="content">
		<ul>
			<li class="phone"><a href="register.html">手机注册</a></li>
			<li class="email"><a href="registerEmail.html">邮箱注册</a></li>
		</ul>
			...
			<div class="gukuan">
				...
				<form action="registerPhoneCheck" method="post" name="form1">
					<div class="form-group">
    					...
    					<div class="col-sm-4">
    					<input type="text" class="form-control" id="firstname" placeholder="请输入手机号码" name="phone" required>
    					</div>
  					</div> 
